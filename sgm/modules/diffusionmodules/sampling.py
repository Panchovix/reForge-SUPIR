...
from ldm_patched.k_diffusion.sampling import BrownianTreeNoiseSampler, get_sigmas_karras
from ldm_patched.k_diffusion.sampling import BrownianTreeNoiseSampler, get_sigmas_karras
...
class RestoreEDMSampler(SingleStepDiffusionSampler):
    ...
    def __call__(self, denoiser, x, cond, uc=None, num_steps=None, x_center=None, control_scale=1.0,
        ...
        pbar_comfy = ldm_patched.modules.utils.ProgressBar(num_sigmas)
...
def gaussian_weights(tile_width, tile_height, nbatches):
    ...
    if ldm_patched.modules.model_management.is_device_mps(device):
