    ...
    def process(self, steps, image, color_fix_type, seed, scale_by, cfg_scale, resize_method, s_churn, s_noise,
        ...
        if diffusion_dtype == 'auto':
            try:
                ...
                raise AttributeError("reForge too old, can't autodecet properly. Set your dtypes manually.")
        else:
        ...
        if encoder_dtype == 'auto':
            try:
                ...
                raise AttributeError("reForge too old, can't autodetect properly. Set your dtypes manually.")
        else:
